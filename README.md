...
Pretend it's 1995, add your website to a [webring](https://en.wikipedia.org/wiki/Webring). This is a retro-style webring for technology law practitioners, academics, students, and resource-creators. Is it the most useful way to find those resources? Certainly not. But it was fun to build as part of my retro website project.

<details><summary>For more on the Webring Starter Kit, click here</summary> 
    
[Template project](https://github.com/maxboeck/webring) inspired by posts from [Tatiana Mac](https://twitter.com/TatianaTMac/status/1114388079630929926) and [Charlie Owen](https://www.sonniesedge.net/posts/webrings).
...
See the __[Demo Site](https://webringdemo.netlify.app)__ generated by this code.
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/maxboeck/webring) </details>
